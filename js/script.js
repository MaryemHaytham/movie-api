...
$(".strip-toggel-menu").click(function(){isTrue?($(".nav-tab-menu")
.addClass("open-menu")
...
$(".nav-tab-menu .nowPlaying").animate(
    {opacity:"1",
    paddingTop:"25px"},
    1100),   
$(".nav-tab-menu .popular").animate(
    {opacity:"1",
    paddingTop:"25px"},
    1200),
$(".nav-tab-menu .toprated").animate(
    {opacity:"1",
    paddingTop:"25px"},
    1300),
$(".nav-tab-menu .trending").animate(
    {opacity:"1",
    paddingTop:"25px"},
    1400),
$(".nav-tab-menu .trending").animate(
    ...
    paddingTop:"25px"},
    1500),
$(".nav-tab-menu .upcomin").animate(
    {opacity:"1",
    paddingTop:"25px"},
    1600),
isTrue=!isTrue):($(".nav-tab-menu")
.addClass("close-menu")
...
$(".strip-search").click(function(){
    ...
    function(){
        $(".search-input")
        .animate({top:"50%"},250)}),
        isSearchTrue=!isSearchTrue):($(".search")
        .addClass("close-search")
        .removeClass("open-menu"),
        $(".fa-search")
        .toggleClass("fa-times"),
        $(".search-input")
        .animate({top:"300%"}),isSearchTrue=!isSearchTrue)});
...
category="",
searchInfo=document.getElementById("word");
getMovies();
for(var i=0;i<categorylinks.length;i++)
    categorylinks[i].addEventListener("click",function(e){
        "Now playing"==(category=e.target.innerHTML)&&(URL=NowURL,getMovies()),
        "Popular"==category?
        (URL=popularURL,getMovies()):"Top Rated"==category?
        (URL=topratedURL,getMovies()):"Latest"==category?
        (URL=latestURL,getMovies()):"Trending"==category?
        (URL=trendingURL,getMovies()):"Upcoming"==category
        ...
        function displayMovies(){
            ...
            if(""==e)return result.innerHTML=" ",!1;
                ...
                function userAgeValid(){
                    ...
                    (userAgeAlert.style.display="block",console.log("dkldkdlkdlk"))}function userPasswordValid(){return 1==/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/.test(userPassword.value)?(userpasswordAlert.style.display="none"):(userpasswordAlert.style.display="block")}
